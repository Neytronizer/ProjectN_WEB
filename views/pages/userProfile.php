        ...
        <div class="user__profile">
             <div class="user__profile__inner">
                <div class="user__profile__inner__header">
                    ...
                    <div class="user__content">
                        <div class="user__profilename">
                            <h1 class="user__name">Azamat</h1>
                            <div class="user__online">
                                <img class="online__sign" scr="images/offline_icon.png">
                                online?
                            </div>
                        </div>
                        <div class="user__reputation">
                            <h1 class="user__REP">Reputation: -
                                <img class="rep_icon" src="images/like.png">
                            </h1>
                        </div>
                        <div class="user__communication">
                ...
                <div class="user__profile__inner__about">
                    ...
                    <p class="user__about__text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quam commodi delectus, tempora nemo ipsum praesentium culpa maiores consequatur illum blanditiis? Quasi quaerat officiis dolorem placeat nihil. Dolorem ipsam omnis similique.
                ...
                <div class="user__profile__inner__statistics">
                    ...
                    <div class="user__profile__inner__statistics__content">
                        <div class="user__profile__inner__statistics__content__date">Join date
                            <h3 class="user__profile__inner__statistics__content__date__numbers">12.12.09</h3>
                        </div>
                        <div class="user__profile__inner__statistics__content__region">Region
                            <div class="user__profile__inner__statistics__content__region__location">Latvia</div>
                        </div>
                    </div>
                </div>
            </div>
